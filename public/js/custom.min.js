...
function init_chart_doughnut() {
    ...
    //***************Empieza canvas gráfica Admin***************
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasUsers").length)) {
        var a = {
            type: "doughnut",
            tooltipFillColor: "rgba(51, 51, 51, 0.55)",
            data: {
                labels: ["Alumnos", "Empresas", "Profesores", "Admins"],
                datasets: [{
                    data: [document.getElementById("studentsNumero").innerHTML, document.getElementById("enterprisesNumero").innerHTML, document.getElementById("teachersNumero").innerHTML, document.getElementById("adminsNumero").innerHTML],
                    backgroundColor: ["#3498DB", "#26B99A", "#9B59B6", "#E74C3C"],
                    hoverBackgroundColor: ["#49A9EA", "#36CAAB", "#B370CF", "#E95E4F"]
                }]
            },
            options: {
                legend: !1,
        ...
        $(".canvasUsers").each(function() {
            var b = $(this);
            new Chart(b, a)
        })
    }
    //***************Termina canvas gráfica Admin***************
}
